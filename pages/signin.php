...
<div class="row justify-content-center">
    <div class="col-lg-6 col-md-8 col-sm-12 col-12">
        <div class="div-register text-center ">
            ...
            <form action="<?php echo $base_url ?>controllers/AuthController.php" method="POST" id="form-register">
                ...
                <div class="form-floating mb-3  <?php echo (!empty($errors['family']) ? "error_class " : '') ?>">
                    <input type="text" class="form-control" name="family" id="floatingInput" placeholder="name@example.com">
                    ...
                    <div class="error-container">
                        ...
                        if (!empty($errors)) {
                            foreach ($errors as $error) {
                                echo  "<div class='div-error  text-center'> <span class='text-danger  m-4 text-center fw-bold error'>$error</span></div>";
                            }
                        }
                        ?>
